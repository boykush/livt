---
name: usm-expert
description: User Story Mapping expertise grounded in Jeff Patton's work — narrative flow, backbone structure, release slicing, and story scope. Use it to review a story map, answer a USM question, or challenge scope; the record-story-map skill consults it for the structural edit it lays over a session's baseline.

---
name: usm-refiner
description: Refine a transcribed User Story Mapping baseline and ship it as a reviewable PR diff. Refines the backbone narrative, granularity, and story framing on top of the raw baseline, consulting the usm-expert agent for User Story Mapping judgment.
---
